...
/**
 * Makes the Google TranslateG API available to Java applications.
 *
...
public class TranslateG {
    ...
    public static final String TAG = "TRANSLATATION SERVICE";
    private static final String APIkey = "9ab066923bbd4b208cd227afccb59431";

    /**
     * Translates text from a given language to another given language using Google TranslateG
     *
